          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-border rounded-xl text-sm text-foreground/80 hover:text-foreground transition-all"
              >
            ...
            {/* Add Category Form */}
            {addingCategory && (
              <div className="bg-card border border-orange-500/30 rounded-2xl p-5 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      className="w-full bg-muted border border-border rounded-lg px-3 py-2 text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/50"
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-orange-500 hover:bg-orange-400 disabled:bg-zinc-700 disabled:text-muted-foreground text-foreground rounded-lg text-sm font-medium transition-all"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-muted hover:bg-zinc-700 text-foreground/80 rounded-lg text-sm transition-all"
                  >
            ...
            {menu.map((cat, catIdx) => {
              ...
              return (
                <div key={cat.category + catIdx} className="bg-card border border-white/8 rounded-2xl overflow-hidden">
                  {/* Category Header */}
                  <div
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-0.5">{cat.items.length} item</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <button
                    ...
                    <div className="border-t border-white/8 px-5 py-3 space-y-1">
                        ...
                        <div key={item.name + itemIdx} className="flex items-center gap-2 py-2 group">
                          {editingItem?.catIdx === catIdx && editingItem?.itemIdx === itemIdx ? (
                            ...
                            <div className="flex-1 flex items-center gap-2">
                              <input
                                className="flex-1 bg-muted border border-orange-500/40 rounded-lg px-3 py-1.5 text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/50"
                              ...
                              />
                              <input
                                className="w-24 bg-muted border border-orange-500/40 rounded-lg px-3 py-1.5 text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/50"
                              ...
                              <button onClick={() => setEditingItem(null)} className="p-1.5 text-muted-foreground hover:bg-white/5 rounded-lg transition-all">
                                <X className="w-4 h-4" />
                              </button>
                            </div>
                          ) : (
                            ...
                            <>
                              ...
                              <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button
                                  ...
                                  className="p-1.5 text-muted-foreground hover:text-foreground hover:bg-white/10 rounded-lg transition-all"
                                >
                      ...
                      {addingItem?.catIdx === catIdx ? (
                        <div className="flex items-center gap-2 pt-2 border-t border-border/50 mt-2">
                          <input
                            className="flex-1 bg-muted border border-orange-500/30 rounded-lg px-3 py-1.5 text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/50"
                            value={newItem.name}
                          ...
                          />
                          <input
                            className="w-24 bg-muted border border-orange-500/30 rounded-lg px-3 py-1.5 text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/50"
                            value={newItem.price}
                          ...
                          <button
                            ...
                            className="p-1.5 text-emerald-400 hover:bg-emerald-500/10 disabled:text-muted-foreground rounded-lg transition-all"
                          >
                            <Check className="w-4 h-4" />
                          </button>
                          <button
                            onClick={() => { setAddingItem(null); setNewItem({ name: "", price: "" }); }}
                            className="p-1.5 text-muted-foreground hover:bg-white/5 rounded-lg transition-all"
                          >
                            <X className="w-4 h-4" />
                          </button>
                        </div>
                        ...
                        <button
                          ...
                          className="flex items-center gap-2 text-sm text-muted-foreground hover:text-orange-400 py-2 w-full transition-colors"
                        >
          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
            {initialFeedback.length === 0 ? (
              <div className="bg-card border border-border rounded-2xl p-12 text-center">
                ...
                <h3 className="text-lg font-medium text-foreground/80 mb-1">Belum ada feedback</h3>
                <p className="text-muted-foreground text-sm">Feedback yang masuk dari pelanggan akan tampil di sini.</p>
              </div>
            ) : (
