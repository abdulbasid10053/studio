  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {feedbacks.map((fb) => (
          <Card key={fb.id} className="p-6 bg-card border-border shadow-lg hover:border-primary/50 transition-colors flex flex-col h-full relative overflow-hidden group">
            {/* Dekorasi tanda kutip */}
            <MessageSquareQuote className="absolute -top-4 -right-4 w-24 h-24 text-foreground/5 -rotate-12 group-hover:text-primary/10 transition-colors" />
            ...
            <div className="relative z-10 flex items-center gap-3 pt-4 border-t border-border">
