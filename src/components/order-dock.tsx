      ...
      <aside className="fixed right-4 bottom-4 z-50 flex flex-col items-end gap-2">
        ...
        {isOrderOpen && (
          <div className="flex flex-col items-end gap-2 pl-6">
            <a href="https://spf.shopee.co.id/1qRmQ9DPHd" target="_blank" rel="noopener" className="flex items-center gap-2 bg-card/15 backdrop-blur-sm border border-border rounded-full px-3 py-1.5 text-sm font-medium hover:bg-accent/40 transition-colors shadow-md text-foreground">
              <ShoppingBag className="w-4 h-4 text-orange-500" /> ShopeeFood
            </a>
            <a href="https://food.grab.com/id/en/restaurant/online-delivery/6-C7DWTPLDGCEZCN?sourceID=20250814_223459_93c228b58e2d42d78cbfcbd284440eec_MEXMPS" target="_blank" rel="noopener" className="flex items-center gap-2 bg-card/15 backdrop-blur-sm border border-border rounded-full px-3 py-1.5 text-sm font-medium hover:bg-accent/20 transition-colors shadow-md text-foreground">
              <Bike className="w-4 h-4 text-green-500" /> GrabFood
            </a>
            <a href="https://gofood.co.id/kebumen/restaurant/nasi-goreng-nasgor-x-starbag-muzar-jl-kha-dahlan-2265f3c9-9aa3-43bc-8022-c396614a1b73" target="_blank" rel="noopener" className="flex items-center gap-2 bg-card/15 backdrop-blur-sm border border-border rounded-full px-3 py-1.5 text-sm font-medium hover:bg-accent/40 transition-colors shadow-md text-foreground">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button 
            onClick={togglePlay} 
            className="rounded-full backdrop-blur-sm bg-accent/15 transition-colors shadow-md text-accent-foreground h-10 w-10 p-0 hover:bg-accent/30"
